export default [
   ...
   {
      title: 'Autonomous Car in Unity',
      imgUrl: '/assets/car.png',
      stack: ['C#', 'Unity'],
      link: 'https://github.com/MattDavies-code/Autonomous-Car-in-Unity/blob/main/README.md',
   },
   {
      title: '2D Platformer Game',
      imgUrl: '/assets/fox.png',
      stack: ['C#', 'Unity'],
   },
   {
      title: 'In Progress: Social Discovery Music App',
      imgUrl: '/assets/app.jpg',
      stack: ['Javascript', 'React Native', 'Java'],
      link: 'https://github.com/MattDavies-code/Exploring-Movie-Trends-Using-IMDb',
   },
]